    ...
    return (
        <div className="w-100 h-100 side-navbar">
            ...
            <div className="d-flex flex-column mt-5">
                ...
                <div onClick={() => setNavigator(1)} className={"w-100 d-flex px-4 py-3 side-nav-item" + (navigator===2 ? " active" : "")} >
                    <MenuBookOutlined />
                    Course
                </div>
                {!user.isAdmin && <div onClick={() => setNavigator(2)} className={"w-100 d-flex px-4 py-3 side-nav-item" + (navigator===1 ? " active" : "")} >
                    <EventNoteOutlined />
                    Time Table
                </div>}
